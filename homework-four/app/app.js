...
//Problem 5
let colorObj = new String("Red Orange Blue Green Purple Yellow");
colorObj = colorObj.valueOf().split(" "); //put color in an array using the string object

let favColorPar = document.getElementById("favColor");
let showFavoriteColor = () => {
    let favColor = colorObj[4]; //fav color is green

    favColorPar.innerHTML = `My favorite color is ${favColor.toLowerCase()}.`;
